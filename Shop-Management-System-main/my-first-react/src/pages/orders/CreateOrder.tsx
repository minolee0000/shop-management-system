...
function CreateOrder() {
    ...
    return (
        <div className="flex h-screen bg-gray-100 text-gray-900">
            <div className="w-[45%] border-r border-gray-300 p-6 bg-gradient-to-br from-blue-600 to-blue-500 shadow-lg">
                ...
                <div className="h-[600px] overflow-y-auto bg-white p-4 rounded-lg shadow">
                    <div className="space-y-5">
                        {products.map((product) => (
                            ...
                            >
                                <div className="flex items-center justify-center w-[20%] h-12 bg-blue-200 rounded-full mr-4">
                                ...
                                <div className="w-[25%] text-lg font-semibold text-blue-700 text-right">
            ...
            <div className="p-10 flex-1 bg-white shadow-lg rounded-lg">
                    ...
                    <div ref={orderRef} className="h-[500px] overflow-y-auto">
                        <table className="w-full text-left text-gray-800 border-separate border-spacing-0">
                            <thead className="bg-blue-700 text-white">
                                <tr>
                                    <th className="py-4 px-4 w-[15%] text-base">ID</th>
                                    <th className="py-4 px-4 w-[60%] text-base">Description</th>
                                    <th className="py-4 px-4 w-[25%] text-base text-right">Price</th>
                                </tr>
                            </thead>
                            <tbody>
                                {orderProducts.map((product, index) => (
                                    <tr key={`${product.id}-${index}`} className="hover:bg-blue-50 transition duration-150">
                                        ...
                                        <td className="border-b py-4 px-2 text-right">Rs.{product.price.toFixed(2)}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                ...
                <button
                    onClick={saveOrder}
                    className="mt-6 bg-gradient-to-r from-blue-700 to-blue-800 hover:from-blue-800 hover:to-blue-700 text-white font-semibold text-lg px-6 py-3 rounded-md transition-transform duration-200 transform hover:scale-105 shadow-md">
                    Place Order
                </button>
            </div>
        </div>
